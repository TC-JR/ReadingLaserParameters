...
namespace BJJCZ_BaseDevelop
{
    ...
    public class JczLmc
    {
        ...
        /// 初始化函数库
        /// </summary>
        /// <param name="PathName">Ezcad2.exe所处的目录的全路径</param>
        /// <param name="bTestMode">指是否是测试模式,测试模式控制卡相关函数无法工作</param>
        /// <param name="MailForm">指拥有用户输入焦点的窗口，用于检测用户暂停消息</param>
        /// <returns>返回值</returns>
        ...
        /// 添加圆
        /// </summary>
        /// <param name="cenX">圆心X坐标</param>
        /// <param name="cenY">圆心Y坐标</param>
        /// <param name="radius">圆半径</param>
        /// <param name="EntName">对象名称</param>
        /// <param name="nPen">使用笔号</param>
        /// <returns>返回值</returns>
        ...
        /// 得到设备参数配置对话框+扩展轴
        /// </summary>
        /// <param name="bAxisShow0">扩展轴0的界面是否显示</param>
        /// <param name="bAxisShow1">扩展轴1的界面是否显示</param>
        /// <returns>返回值</returns>
        ...
        /// <param name="dCenterX">旋转中心的x坐标</param>
        /// <param name="dCenterY">旋转中心的y坐标</param>
        /// <param name="dRotateAng">为旋转角度,单位为弧度值</param>
        /// <returns></returns>
        ...
        /// 标刻指定对象一次
        /// </summary>
        /// <param name="EntName">指定对象的名字</param>
        /// <returns>返回值</returns>
        ...
        /// </summary>   
        /// <param name="EntName">对象名称</param>
        /// <param name="bContour">显示的是否是轮廓</param>
        /// <returns>返回值</returns>
        ...
        /// 获取流水线速度
        /// </summary>
        /// <param name="FlySpeed">流水线当前速度</param>
        /// <returns>返回值</returns>
        ...
        /// 获取当前振镜的命令坐标
        /// </summary>
        /// <param name="x">获取X坐标</param>
        /// <param name="y">获取Y坐标</param>
        /// <returns>返回值</returns>
        ...
        /// </summary>
        /// <param name="FileName">文件全路径带名称</param>
        /// <returns>返回值</returns>
        ...
        /// 保存当前数据到指定文件
        /// </summary>
        /// <param name="strFileName">文件全路径带名称</param>
        /// <returns>返回值</returns>
        ...
        /// 删除指定对象释放资源
        /// </summary>
        /// <param name="hObject">指定删除的对象</param>
        /// <returns>返回值</returns>
        [DllImport("gdi32.dll")]
        ...
        /// <summary>
        /// 对数据库中指定名称的对象进行比例变换,变换前所有构成对象的点到变换中心距离按变换比例变换，对应为变换后的图形坐标
        /// </summary>
        /// <param name="strEntName">对象名称</param>
        /// <param name="dCenx">变换中心的X坐标</param>
        /// <param name="dCeny">变换中心的Y坐标</param>
        /// <param name="dScaleX">X方向变换比例</param>
        /// <param name="dScaleY">Y方向变换比例</param>
        /// <returns>返回值</returns>
        ...
        /// </summary>
        /// <param name="strEntName">对象名称</param>
        /// <param name="dCenx">X镜像中心坐标</param>
        /// <param name="dCeny">Y镜像中心坐标</param>
        /// <param name="bMirrorX">X镜像</param>
        /// <param name="bMirrorY">Y镜像</param>
        /// <returns></returns>
        ...
        /// </summary>
        /// <param name="strEntName">对象名称</param>
        /// <param name="dCenx">旋转中心的x坐标</param>
        /// <param name="dCeny">旋转中心的y坐标</param>
        /// <param name="dAngle">为旋转角度,单位为弧度值</param>
        /// <returns>返回值</returns>
        ...
        /// 获得指定序号的对象名称
        /// </summary>
        /// <param name="nEntityIndex">序号</param>
        /// <param name="entname">得到名称</param>
        /// <returns>返回值</returns>
        ...
        /// 对数据库中指定名称的对象群组
        /// </summary>
        /// <param name="strEntName1">被群组的对象1</param>
        /// <param name="strEntName2">被群组的对象2</param>
        /// <param name="strGroupName">群组名称</param>
        /// <param name="nGroupPen">群组后对象笔号</param>
        /// <returns>返回值</returns>
        ...
        /// 对数据库中指定名称的对象解散群组
        /// </summary>
        /// <param name="strGroupName">被解散群组的对象</param>
        /// <returns>返回值</returns>
        ...
        /// 对数据库中指定的对象群组
        /// </summary>
        /// <param name="strEntName">对象名称列表</param>
        /// <param name="nEntCount">群组对象数量</param>
        /// <param name="strGroupName">群组后名称</param>
        /// <param name="nGroupPen">群组后对象笔号</param>
        /// <returns>返回值</returns>
        ...
        /// <param name="nBmpAttrib">位图参数</param>
        /// <param name="nScanAttrib">扫描参数</param>
        /// <param name="dBrightness">亮度设置</param>
        /// <param name="dContrast">对比度设置</param>
        /// <param name="dPointTime">打点时间设置</param>
        /// <param name="nImportDpi">DPI</param>
        /// <param name="bDisableMarkLowGrayPt">是否标刻低灰度值</param>
        /// <param name="nMinLowGrayPt">最低灰度值</param>
        /// <returns>返回值</returns>
        ...
        /// </summary>
        /// <param name="EntName">对象名称</param>
        /// <param name="NewText">新指定的内容</param>
        /// <returns>返回值</returns>
        ...
        /// 得到指定对象的文本
        /// </summary>
        /// <param name="strEntName">文本对象名称</param>
        /// <param name="Text">获取的内容</param>
        /// <returns>返回值</returns>
        ...
        /// 重置序列号对象
        /// </summary>
        /// <param name="TextName">文本对象名称</param>
        /// <returns>返回值</returns>
        ...
        /// 得到数据库中字体记录的总数
        /// </summary>
        /// <param name="fontCount">字体数量</param>
        /// <returns>返回值</returns>
        ...
        /// </summary>
        /// <param name="fontIndex">字体序号</param>
        /// <param name="fontName">字体名称</param>
        /// <param name="fontAttrib">字体类型参数</param>
        /// <returns>返回值</returns>
        ...
        /// <param name="CharHeight">字符高度</param>
        /// <param name="CharWidthRatio">字符宽度</param>
        /// <param name="CharAngle">字体角度</param>
        /// <param name="CharSpace">字体间距</param>
        /// <param name="LineSpace">行间距</param>
        /// <param name="EqualCharWidth">是否等宽</param>
        /// <param name="nTextAlign">文本对齐方式</param>
        ...
        /// <param name="CharSpace">字体间距</param>
        /// <param name="LineSpace">行间距</param>
        /// <param name="spaceWidthRatio">空间宽度比</param>
        /// <param name="EqualCharWidth">是否等宽</param>
        /// <param name="nTextAlign">文本对齐方式</param>
        /// <param name="bBold">粗体</param>
        /// <param name="bItalic">斜体</param>
        ...
        /// 设置指定文本的字体参数
        /// </summary>
        /// <param name="EntName">字体名称</param>
        /// <param name="CharHeight">字符高度</param>
        /// <param name="CharWidthRatio">字符宽度</param>
        /// <param name="CharAngle">字符倾角</param>
        /// <param name="CharSpace">字符间距</param>
        /// <param name="LineSpace">行间距</param>
        /// <param name="EqualCharWidth">等字符宽度模式</param>
        /// <returns>返回值</returns>
        ...
        /// <param name="CharSpace">字符间距</param>
        /// <param name="LineSpace">行间距</param>
        /// <param name="spaceWidthRatio">空字符宽带</param>
        /// <param name="EqualCharWidth">等字符宽度模式</param>
        /// <returns>返回值</returns>
        ...
        /// <param name="EntName">文本名称</param>
        /// <param name="FontName">字体名称</param>
        /// <param name="nTextSpaceMode">文本间距模式</param>
        /// <param name="dTextSpace">文本间距距离</param>
        /// <param name="CharHeight">字符高度</param>
        /// <param name="CharWidthRatio">字符宽度</param>
        /// <param name="CharAngle">字符倾角（弧度值）</param>
        /// <param name="CharSpace">字符间距</param>
        /// <param name="LineSpace">行间距</param>
        /// <param name="dNullCharWidthRatio">空字符宽带</param>
        /// <param name="nTextAlign">文本对齐方式</param>
        /// <param name="bBold">粗体</param>
        /// <param name="bItalic">斜体</param>
        /// <returns>返回值</returns>
        ...
        /// 获得指定圆弧文本对象的参数
        /// </summary>
        /// <param name="pEntName">对象名称</param>
        /// <param name="dCenX">文本所在基准圆的x坐标</param>
        /// <param name="dCenY">文本所在基准圆的y坐标</param>
        /// <param name="dCenZ">字符z坐标</param>
        /// <param name="dCirDiameter">基准圆直径</param>
        /// <param name="dCirBaseAngle">文字基准角度</param>
        /// <param name="bCirEnableAngleLimit">是否使能角度限制</param>
        /// <param name="dCirAngleLimit">限制的角度</param>
        /// <param name="nCirTextFlag">文本在圆上的方向</param>
        /// <returns>返回值</returns>
        ...
        /// 设置指定圆弧文本对象的参数
        /// </summary>
        /// <param name="pEntName">字符串对象名称</param>
        /// <param name="dCenX">文本所在基准圆的x坐标</param>
        /// <param name="dCenY">文本所在基准圆的y坐标</param>
        /// <param name="dCenZ">字符z坐标</param>
        /// <param name="dCirDiameter">基准圆直径</param>
        ...
        /// <param name="bWobbleMode">抖动模式</param>
        /// <param name="bWobbleDiameter">抖动直径</param>
        /// <param name="bWobbleDist">抖动间距</param>
        /// <returns>返回值</returns>
        ...
        /// <param name="pStrName">笔名字，默认default</param>
        /// <param name="clr">笔颜色</param>
        /// <param name="bDisableMark">是否使能笔号，true关闭笔号不标刻</param>
        /// <param name="bUseDefParam">是否使用默认值</param>
        ...
        /// <param name="dJumpLengthLimit">跳转长的极限</param>
        /// <param name="dPointTimeMs">打点时间 ms</param>
        ...
        /// <param name="dBreakAngle">中断角度</param>
        /// <param name="bWobbleMode">抖动模式</param>
        /// <param name="bWobbleDiameter">抖动直径</param>
        /// <param name="bWobbleDist">抖动间距</param>
        /// <returns>返回值</returns>
        ...
        public static extern int SetPenParam4(int nPenNo,//笔号
                                                            string pStrName,    // 名称
                                                            int clr,//颜色
        ...
        public static extern int SetHatchParam2(bool bEnableContour,//使能轮廓本身
        ...
        public static extern int SetHatchParam3(bool bEnableContour,//使能轮廓本身
                                                          int nParamIndex,//填充参数序号值为1,2,3
                                                          int bEnableHatch,//使能填充
                                                          int nPenNo,//填充参数笔号
                                                          int nHatchType,//填充类型 0单向 1双向 2回形 3弓形 4弓形不反向
